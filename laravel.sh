...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=obamstracon/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=obamstracon/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=obam4real/' /var/www/html/laravel/.env
